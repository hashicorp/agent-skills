# Specification: vault-deployment
...
This plugin helps you **deploy and operate Vault**. Covers Kubernetes integration (VSO, Agent Injector, CSI Provider), production operations (HA, DR, monitoring, backup, upgrades), and troubleshooting common issues.
