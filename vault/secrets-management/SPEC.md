# Specification: vault-secrets-management
...
This plugin provides skills for configuring and managing Vault secrets engines and Vault Agent for secret delivery. Covers static secrets (KV), dynamic credentials (Database, AWS, Azure, GCP), encryption-as-a-service (Transit), certificates (PKI), and SSH access.
