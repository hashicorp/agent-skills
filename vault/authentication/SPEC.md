# Specification: vault-authentication
...
This plugin provides skills for configuring Vault authentication methods, writing access control policies, managing tokens, configuring the identity system, and implementing secure secret distribution patterns. Covers machine authentication (AppRole, Kubernetes, AWS, Azure, GCP), human authentication (OIDC, LDAP), token lifecycle, identity entities and groups, and response wrapping.
