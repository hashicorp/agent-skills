# Specification: vault-ai-workflows
...
This plugin helps you **use AI assistants to manage Vault secrets**. Covers the HashiCorp Vault MCP (Model Context Protocol) Server setup, VS Code and Claude Desktop integration, and common secrets management workflows using MCP tools.
